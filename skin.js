...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__94.logicBlock_position = function() {
			...
			if (me.__94.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me.__94.ggCurrentLogicStatePosition = newLogicStatePosition;
				me.__94.style.transition='right 500ms ease 0ms, bottom 500ms ease 0ms';
				if (me.__94.ggCurrentLogicStatePosition == 0) {
					me.__94.style.right='0px';
					me.__94.style.bottom='0%';
				}
				else {
					me.__94.style.right='0px';
					me.__94.style.bottom='-100%';
				}
			}
		}
		me.__94.logicBlock_position();
		...
		me.__100.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
			...
			if (me.__100.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me.__100.ggCurrentLogicStatePosition = newLogicStatePosition;
				me.__100.style.transition='left 0s, top 0s';
				if (me.__100.ggCurrentLogicStatePosition == 0) {
					me.__100.style.left='0px';
					me.__100.style.top='-52%';
				}
				else {
					me.__100.style.left='0px';
					me.__100.style.top='-55%';
				}
			}
		}
		me.__100.logicBlock_position();
		me.__100.ggUpdatePosition=function (useTransition) {
		}
		me.__94.appendChild(me.__100);
		...
		el.ggUpdate = function(filter) {
			if(me.__98.ggUpdating == true) return;
			me.__98.ggUpdating = true;
			var el=me.__98;
			var curNumRows = 0;
			curNumRows = me.__98.ggNumRepeat;
			...
			var centerOffsetVert = 0;
				me.__98.ggCloneOffsetChanged = false;
			}
			...
			tourNodes = me.__98.getFilteredNodes(tourNodes, filter);
			me.__98.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__98.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__98.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__98.ggWidth) + 'px';
				parameter.width=me.__98.ggWidth + 'px';
				parameter.height=me.__98.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__98_Class(nodeId, me, el, parameter);
				currentIndex++;
			...
			me.__98.ggNodeCount = me.__98.ggNumFilterPassed;
			me.__98.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__98.parentNode && me.__98.parentNode.classList.contains('ggskin_subelement') && me.__98.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__98.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "가구있음";
		el.ggFilter[1] = "메인";
		...
		me.__98.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me.__98.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__98.ggCurrentLogicStateSize = newLogicStateSize;
				me.__98.style.transition='width 0s, height 0s';
				if (me.__98.ggCurrentLogicStateSize == 0) {
					me.__98.ggWidth=100;
					me.__98.ggHeight=150;
					me.__98.ggUpdate();
					skin.updateSize(me.__98);
				}
				else {
					me.__98.ggWidth=150;
					me.__98.ggHeight=180;
					me.__98.ggUpdate();
					skin.updateSize(me.__98);
				}
			}
		}
		me.__98.logicBlock_size();
		...
		me.__98.ggCurrentLogicStateSize = -1;
		me.__98.ggCurrentLogicStateVisible = -1;
		me.__98.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__98.childNodes.length; i++) {
				var child=me.__98.childNodes[i];
		...
		me.__95.appendChild(me.__98);
		el=me.__96=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me.__96;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		el.ggUpdate = function(filter) {
			if(me.__96.ggUpdating == true) return;
			me.__96.ggUpdating = true;
			var el=me.__96;
			var curNumRows = 0;
			curNumRows = me.__96.ggNumRepeat;
			if (curNumRows < 1) curNumRows = 1;
			if (typeof filter=='object') {
				el.ggFilter = filter;
			} else {
			...
			var centerOffsetHor = 0;
			var centerOffsetVert = 0;
				me.__96.ggCloneOffsetChanged = false;
			}
			el.ggCurrentFilter = filter;
			el.ggInstances = [];
			if (el.hasChildNodes() == true) {
			...
			var currentIndex = 0;
			var keepCloning = true;
			tourNodes = me.__96.getFilteredNodes(tourNodes, filter);
			me.__96.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__96.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__96.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__96.ggWidth) + 'px';
				parameter.width=me.__96.ggWidth + 'px';
				parameter.height=me.__96.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__96_Class(nodeId, me, el, parameter);
				currentIndex++;
				el.ggInstances.push(inst);
				el.appendChild(inst.__div);
				inst.__div.ggObj=inst;
			...
			me.__96.ggNodeCount = me.__96.ggNumFilterPassed;
			me.__96.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__96.parentNode && me.__96.parentNode.classList.contains('ggskin_subelement') && me.__96.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__96.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "가구없음";
		el.ggFilter[1] = "메인";
		...
		me.__96.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me.__96.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__96.ggCurrentLogicStateSize = newLogicStateSize;
				me.__96.style.transition='width 0s, height 0s';
				if (me.__96.ggCurrentLogicStateSize == 0) {
					me.__96.ggWidth=100;
					me.__96.ggHeight=150;
					me.__96.ggUpdate();
					skin.updateSize(me.__96);
				}
				else {
					me.__96.ggWidth=150;
					me.__96.ggHeight=200;
					me.__96.ggUpdate();
					skin.updateSize(me.__96);
				}
			}
		}
		me.__96.logicBlock_size();
		...
		me.__96.ggCurrentLogicStateSize = -1;
		me.__96.ggCurrentLogicStateVisible = -1;
		me.__96.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__96.childNodes.length; i++) {
				var child=me.__96.childNodes[i];
				if (child.ggObj && child.ggObj.ggNodeId==cnode) {
			        var childOffX = child.offsetLeft;
			        var childOffY = child.offsetTop;
					var p = child.parentElement;
		...
		me._scrollarea_1__content.appendChild(me.__95);
		...
		me.__94.appendChild(me._scrollarea_1);
		...
		me.__54.logicBlock_position = function() {
			...
			if (me.__54.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__54.style.transition='right 0s, top 0s, transform 0s';
				if (me.__54.ggCurrentLogicStatePosition == 0) {
					me.__54.style.right='2px';
					me.__54.style.top = 'calc(50% - (483px / 2) + (0px / 2) + 5px)';
				}
				else {
					me.__54.style.right='15px';
					me.__54.style.top='calc(50% - ((483px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__91.appendChild(me._timer_1);
		me.__57.appendChild(me.__91);
		...
		me.__87.onclick=function (e) {
			...
			me.__90.ggVisible = !me.__90.ggVisible;
			var flag=me.__90.ggVisible;
			me.__90.style.transition='none';
			me.__90.style.visibility=((flag)&&(Number(me.__90.style.opacity)>0||!me.__90.style.opacity))?'inherit':'hidden';
			if (
				(
					((player.getViewerSize().width <= 460))
				)
		...
		me.__82.logicBlock_visible = function() {
			...
			if (me.__82.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				else if (me.__82.ggCurrentLogicStateVisible == 1) {
					me.__82.style.visibility="hidden";
					me.__82.ggVisible=false;
				}
				else {
		...
		me.__82.onmouseover=function (e) {
			me.elementMouseOver['_82']=true;
		}
		me.__82.onmousemove=function (e) {
		...
		me.__82.onmouseout=function (e) {
			me.elementMouseOver['_82']=false;
		}
		me.__82.ggCurrentLogicStateVisible = -1;
		me.__82.ggUpdateConditionTimer=function () {
			if (me.elementMouseOver['_82']) {
				me.__83.style.transition='none';
				me.__83.style.visibility=(Number(me.__83.style.opacity)>0||!me.__83.style.opacity)?'inherit':'hidden';
				me.__83.ggVisible=true;
			}
		...
		me.__81.ggIsActive=function() {
			return (me.__81.ggTimestamp==0 ? false : (Math.floor((skin.ggCurrentTime - me.__81.ggTimestamp) / me.__81.ggTimeout) % 2 == 0));
		}
		el.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
		...
		me._onoff.appendChild(me.__80);
		me.__57.appendChild(me._onoff);
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
			me.__68.ggVisible = !me.__68.ggVisible;
			var flag=me.__68.ggVisible;
			me.__68.style.transition='none';
			me.__68.style.visibility=((flag)&&(Number(me.__68.style.opacity)>0||!me.__68.style.opacity))?'inherit':'hidden';
		...
		me.__58.ggIsActive=function() {
			return (me.__58.ggTimestamp==0 ? false : (Math.floor((skin.ggCurrentTime - me.__58.ggTimestamp) / me.__58.ggTimeout) % 2 == 0));
		}
		el.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
		...
		me._rectangle_2.appendChild(me.__57);
		me.__54.appendChild(me._rectangle_2);
		...
		me.__56.logicBlock_position = function() {
			...
			if (me.__56.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__56.style.transition='left 500ms ease 500ms, top 500ms ease 500ms, opacity 500ms ease 0ms';
				if (me.__56.ggCurrentLogicStatePosition == 0) {
					me.__56.style.left='-10px';
					me.__56.style.top = 'calc(50% - (43px / 2))';
				}
				else if (me.__56.ggCurrentLogicStatePosition == 1) {
					me.__56.style.left='20px';
					me.__56.style.top = 'calc(50% - (43px / 2))';
				}
				else {
					me.__56.style.left='0px';
					me.__56.style.top='calc(50% - ((43px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__56.logicBlock_alpha = function() {
			...
			if (me.__56.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__56.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__56.style.transition='left 500ms ease 500ms, top 500ms ease 500ms, opacity 500ms ease 0ms';
				if (me.__56.ggCurrentLogicStateAlpha == 0) {
					me.__56.style.visibility=me.__56.ggVisible?'inherit':'hidden';
					me.__56.style.opacity=1;
				}
				else if (me.__56.ggCurrentLogicStateAlpha == 1) {
					setTimeout(function() { if (me.__56.style.opacity == 0.0) { me.__56.style.visibility="hidden"; } }, 505);
					me.__56.style.opacity=0;
				}
				else {
					setTimeout(function() { if (me.__56.style.opacity == 0.0) { me.__56.style.visibility="hidden"; } }, 505);
					me.__56.style.opacity=0;
		...
		me.__56.appendChild(me._rectangle_3);
		...
		me.__45.logicBlock_position = function() {
			...
			if (me.__45.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__45.style.transition='left 0s, top 0s, width 0s, height 0s, transform 0s';
				if (me.__45.ggCurrentLogicStatePosition == 0) {
					me.__45.style.left='10px';
					me.__45.style.top='45px';
				}
				else {
					me.__45.style.left='15px';
					me.__45.style.top='80px';
				}
			}
		}
		me.__45.logicBlock_position();
		me.__45.logicBlock_size = function() {
			var newLogicStateSize;
			if (
			...
			if (me.__45.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__45.ggCurrentLogicStateSize = newLogicStateSize;
				me.__45.style.transition='left 0s, top 0s, width 0s, height 0s, transform 0s';
				if (me.__45.ggCurrentLogicStateSize == 0) {
					me.__45.style.width='110px';
					me.__45.style.height='100px';
					skin.updateSize(me.__45);
				}
				else if (me.__45.ggCurrentLogicStateSize == 1) {
					me.__45.style.width='160px';
					me.__45.style.height='150px';
					skin.updateSize(me.__45);
				}
				else {
					me.__45.style.width='200px';
					me.__45.style.height='200px';
					skin.updateSize(me.__45);
				}
			}
		}
		me.__45.logicBlock_size();
		...
		me.__48.logicBlock_scaling = function() {
			...
			if (me.__48.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__48.ggCurrentLogicStateScaling == 0) {
					me.__48.ggParameter.sx = 0.7;
					me.__48.ggParameter.sy = 0.7;
		...
		me._rectangle_41.appendChild(me.__48);
		me.__46.appendChild(me._rectangle_41);
		...
		me.__46.appendChild(me._map_11);
		...
		me.__46.appendChild(me._map_21);
		...
		me.__42.logicBlock_position = function() {
			...
			if (me.__42.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__42.style.transition='left 500ms ease 0ms, bottom 500ms ease 0ms';
				if (me.__42.ggCurrentLogicStatePosition == 0) {
					me.__42.style.left='5px';
					me.__42.style.bottom='-120px';
				}
				else {
					me.__42.style.left='5px';
					me.__42.style.bottom='-10px';
				}
			}
		}
		...
		me.__42.logicBlock_visible = function() {
			...
			if (me.__42.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				else if (me.__42.ggCurrentLogicStateVisible == 2) {
					me.__42.style.visibility="hidden";
					me.__42.ggVisible=false;
				}
				else if (me.__42.ggCurrentLogicStateVisible == 3) {
					me.__42.style.visibility="hidden";
					me.__42.ggVisible=false;
				}
				else {
		...
		me.__44.logicBlock_scaling = function() {
			...
			if (me.__44.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__44.ggCurrentLogicStateScaling == 0) {
					me.__44.ggParameter.sx = 0.7;
					me.__44.ggParameter.sy = 0.7;
		...
		me._rectangle_40.appendChild(me.__44);
		me.__43.appendChild(me._rectangle_40);
		...
		me.__43.appendChild(me._map_10);
		...
		me.__43.appendChild(me._map_20);
		...
		me.__43.appendChild(me._text_4);
		...
		me.__40.logicBlock_size = function() {
			...
			if (me.__40.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me.__40.style.transition='width 0s, height 0s';
				if (me.__40.ggCurrentLogicStateSize == 0) {
					me.__40.style.width='90%';
					me.__40.style.height='100%';
					me.__40.style.left = 'calc(50% - (90% / 2))';
					me.__40.style.top = 'calc(50% - (100% / 2))';
					skin.updateSize(me.__40);
				}
				else {
					me.__40.style.width='100%';
					me.__40.style.height='100%';
					me.__40.style.left = 'calc(50% - (100% / 2))';
					me.__40.style.top = 'calc(50% - (100% / 2))';
					skin.updateSize(me.__40);
				}
			}
		...
		me._rectangle_4.appendChild(me.__40);
		...
		me.__1.logicBlock_position = function() {
			...
			if (me.__1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__1.ggCurrentLogicStatePosition == 0) {
					me.__1.style.left='0px';
					me.__1.style.top='5px';
				}
				else if (me.__1.ggCurrentLogicStatePosition == 1) {
					me.__1.style.left='25px';
					me.__1.style.top='5px';
				}
				else {
					me.__1.style.left='0px';
					me.__1.style.top='4.8px';
				}
			}
		}
		...
		me.__1.logicBlock_scaling = function() {
			...
			if (me.__1.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				else if (me.__1.ggCurrentLogicStateScaling == 1) {
					me.__1.ggParameter.sx = 1;
					me.__1.ggParameter.sy = 0.9;
					me.__1.style.transform=parameterToTransform(me.__1.ggParameter);
					skin.updateSize(me.__1);
				}
				else {
		...
		me.__2.logicBlock_position = function() {
			...
			if (me.__2.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__2.ggCurrentLogicStatePosition == 0) {
					me.__2.style.left='-9%';
					me.__2.style.top='0px';
				}
				else {
					me.__2.style.left='-13%';
					me.__2.style.top='0px';
				}
			}
		}
		...
		me.__3.logicBlock_position = function() {
			...
			if (me.__3.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__3.style.transition='right 0s, top 0s, width 0s, height 0s';
				if (me.__3.ggCurrentLogicStatePosition == 0) {
					me.__3.style.right='28%';
					me.__3.style.top='0px';
				}
				else if (me.__3.ggCurrentLogicStatePosition == 1) {
					me.__3.style.right='20%';
					me.__3.style.top='0px';
				}
				else if (me.__3.ggCurrentLogicStatePosition == 2) {
					me.__3.style.right='5%';
					me.__3.style.top='0px';
				}
				else {
					me.__3.style.right='-2.6%';
					me.__3.style.top='0px';
				}
			}
		}
		...
		els=me.__74a0__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="74A";
		el.ggDy=0;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__74a0.ggUpdateText=function() {
			var params = [];
		...
		me.__74a0.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize().width <= 460))
			)
			...
			if (me.__74a0.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me.__74a0.ggCurrentLogicStatePosition = newLogicStatePosition;
				me.__74a0.style.transition='left 0s, top 0s';
				if (me.__74a0.ggCurrentLogicStatePosition == 0) {
					me.__74a0.style.left='10px';
					me.__74a0.style.top = 'calc(50% - (40px / 2))';
				}
				else if (me.__74a0.ggCurrentLogicStatePosition == 1) {
					me.__74a0.style.left='10px';
					me.__74a0.style.top = 'calc(50% - (40px / 2))';
				}
				else {
					me.__74a0.style.left='30px';
					me.__74a0.style.top='calc(50% - ((40px + 0px) / 2) + 0px)';
				}
			}
		}
		me.__74a0.logicBlock_position();
		...
		me.__3.appendChild(me.__74a0);
		el=me.__74b0=document.createElement('div');
		els=me.__74b0__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="74B";
		el.ggDy=0;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__74b0.ggUpdateText=function() {
			var params = [];
		...
		me.__74b0.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize().width <= 640))
			)
			...
			if (me.__74b0.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me.__74b0.ggCurrentLogicStatePosition = newLogicStatePosition;
				me.__74b0.style.transition='right 0s, top 0s, width 0s, height 0s';
				if (me.__74b0.ggCurrentLogicStatePosition == 0) {
					me.__74b0.style.right='-20px';
					me.__74b0.style.top = 'calc(50% - (40px / 2))';
				}
				else {
					me.__74b0.style.right='20px';
					me.__74b0.style.top='calc(50% - ((40px + 0px) / 2) + 0px)';
				}
			}
		}
		me.__74b0.logicBlock_position();
		me.__74b0.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 460))
			)
			...
			if (me.__74b0.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__74b0.ggCurrentLogicStateSize = newLogicStateSize;
				me.__74b0.style.transition='right 0s, top 0s, width 0s, height 0s';
				if (me.__74b0.ggCurrentLogicStateSize == 0) {
					me.__74b0.style.width='50%';
					me.__74b0.style.height='40px';
					me.__74b0.style.top = 'calc(50% - (40px / 2))';
					skin.updateSize(me.__74b0);
				}
				else {
					me.__74b0.style.width='40%';
					me.__74b0.style.height='40px';
					me.__74b0.style.top = 'calc(50% - (40px / 2))';
					skin.updateSize(me.__74b0);
				}
		...
		me.__74b0.logicBlock_size();
		me.__74b0.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player._(me.ggUserdata.comment) != "\uc5f0\ub9bd\ud615"))
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me.__74b0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__74b0.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__74b0.style.transition='right 0s, top 0s, width 0s, height 0s';
				if (me.__74b0.ggCurrentLogicStateVisible == 0) {
					me.__74b0.style.visibility=(Number(me.__74b0.style.opacity)>0||!me.__74b0.style.opacity)?'inherit':'hidden';
					me.__74b0.ggVisible=true;
				}
				else {
					me.__74b0.style.visibility="hidden";
					me.__74b0.ggVisible=false;
				}
			}
		}
		me.__74b0.logicBlock_visible();
		...
		me.__4.logicBlock_size = function() {
			...
			if (me.__4.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__4.ggCurrentLogicStateSize == 0) {
					...
					me.__4.style.height='150px';
					skin.updateSize(me.__4);
				}
				else {
					me.__4.style.width='100%';
					me.__4.style.height='1px';
					skin.updateSize(me.__4);
				}
			}
		}
		...
		me._c_type.onclick=function (e) {
			player.openUrl("https:\/\/effortless-tiramisu-1c2b58.netlify.app","_self");
		}
		...
		me.__5.appendChild(me._a_type);
		me.__4.appendChild(me.__5);
		me.__74b0.appendChild(me.__4);
		...
		me.__74b0.appendChild(me._image_5);
		me.__3.appendChild(me.__74b0);
		...
		me.__74a.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player._(me.ggUserdata.comment) == "\ub2e8\ub3c5\ud615"))
			)
			...
			if (me.__74a.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__74a.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__74a.style.transition='left 0s, top 0s, background-color 0s';
				if (me.__74a.ggCurrentLogicStateVisible == 0) {
					me.__74a.style.visibility=(Number(me.__74a.style.opacity)>0||!me.__74a.style.opacity)?'inherit':'hidden';
					me.__74a.ggVisible=true;
				}
				else {
					me.__74a.style.visibility="hidden";
					me.__74a.ggVisible=false;
				}
			}
		}
		me.__74a.logicBlock_visible();
		...
		me.__74b.logicBlock_position = function() {
			...
			if (me.__74b.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__74b.style.transition='right 0s, top 0s, background-color 0s';
		...
		me.__2.appendChild(me._container_2);
		...
		player.addListener('changenode', function(event) {
			...
			me.__95.logicBlock_visible();
			me.__98.logicBlock_visible();
			me.__98.ggUpdateConditionNodeChange();
			me.__96.logicBlock_visible();
			me.__96.ggUpdateConditionNodeChange();
			me.__38c.logicBlock_visible();
			me.__38c2.logicBlock_visible();
		...
		player.addListener('sizechanged', function(event) {
			...
			for(var i = 0; i < me.__96.ggInstances.length; i++) {
				me.__96.ggInstances[i].ggEvent_sizechanged(event);
			}
			for(var i = 0; i < me.__98.ggInstances.length; i++) {
				me.__98.ggInstances[i].ggEvent_sizechanged(event);
			}
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
	...
	function SkinCloner__96_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		me._rectangle_1.appendChild(me.__97);
	...
	function SkinCloner__98_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		me._rectangle_10.appendChild(me.__99);
		...
		me.__0.logicBlock_position = function() {
			...
			if (me.__0.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__0.ggCurrentLogicStatePosition == 0) {
					me.__0.style.left = 'calc(50% - (65px / 2))';
					me.__0.style.bottom='0px';
				}
				else {
					me.__0.style.left='calc(50% - ((65px + 0px) / 2) + 0px)';
		...
		me.__0.logicBlock_size = function() {
			...
			if (me.__0.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__0.ggCurrentLogicStateSize == 0) {
					me.__0.style.width='100px';
					me.__0.style.height='25px';
					me.__0.style.left = 'calc(50% - (100px / 2))';
					skin.updateSize(me.__0);
				}
				else {
					me.__0.style.width='65px';
					me.__0.style.height='25px';
					me.__0.style.left = 'calc(50% - (65px / 2))';
					skin.updateSize(me.__0);
				}
		...
		me.__0.logicBlock_backgroundcolor = function() {
			...
			if (me.__0.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__0.ggCurrentLogicStateBackgroundColor == 0) {
					...
					me.__0.style.backgroundColor="rgba(255,255,255,0.54902)";
				}
			}
		}
		...
		me.__.logicBlock_position = function() {
			...
			if (me.__.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__.ggCurrentLogicStatePosition == 0) {
					me.__.style.left = 'calc(50% - (65px / 2))';
					me.__.style.bottom='0px';
				}
				else if (me.__.ggCurrentLogicStatePosition == 1) {
					me.__.style.left = 'calc(50% - (65px / 2) + (0px / 2) + -5px)';
					me.__.style.bottom='40px';
				}
				else {
					me.__.style.left='calc(50% - ((65px + 0px) / 2) + 0px)';
					me.__.style.bottom='-40px';
				}
			}
		}
		...
		me.__.logicBlock_size = function() {
			...
			if (me.__.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__.ggCurrentLogicStateSize == 0) {
					...
					me.__.style.width='100px';
					me.__.style.height='30px';
					me.__.style.left = 'calc(50% - (100px / 2))';
					skin.updateSize(me.__);
				}
				else {
					me.__.style.width='65px';
					me.__.style.height='30px';
					me.__.style.left = 'calc(50% - (65px / 2))';
					skin.updateSize(me.__);
				}
		...
		me.__.logicBlock_backgroundcolor = function() {
			...
			if (me.__.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__.ggCurrentLogicStateBackgroundColor == 0) {
					...
					me.__.style.backgroundColor="rgba(255,255,255,0.54902)";
				}
			}
		}
		...
		me._map_pin_active2.logicBlock_size = function() {
			...
			if (me._map_pin_active2.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._map_pin_active2.ggCurrentLogicStateSize == 0) {
					...
					me._map_pin_active2.style.width='28px';
					me._map_pin_active2.style.height='28px';
					me._map_pin_active2.style.left = 'calc(50% - (28px / 2))';
					me._map_pin_active2.style.top = 'calc(50% - (28px / 2))';
					skin.updateSize(me._map_pin_active2);
				}
			}
		}
	...
	me.skinTimerEvent=function() {
		...
		me.__82.ggUpdateConditionTimer();
		me.__81.ggUpdateConditionTimer();
		if (me.__81.ggLastIsActive!=me.__81.ggIsActive()) {
			me.__81.ggLastIsActive=me.__81.ggIsActive();
			if (me.__81.ggLastIsActive) {
				me.__83.style.transition='none';
				me.__83.style.visibility='hidden';
				me.__83.ggVisible=false;
			} else {
		...
		if (me.__58.ggLastIsActive!=me.__58.ggIsActive()) {
			me.__58.ggLastIsActive=me.__58.ggIsActive();
			if (me.__58.ggLastIsActive) {
				me.__60.style.transition='none';
				me.__60.style.visibility='hidden';
				me.__60.ggVisible=false;
			} else {
		...
		var hs='';
		if (me.__41.ggParameter) {
			hs+=parameterToTransform(me.__41.ggParameter) + ' ';
		}
		hs+='translate(' + (1 * player.mouse.x + -35) + 'px,0px) ';
		hs+='translate(0px,' + (1 * player.mouse.y + 20) + 'px) ';
		me.__41.style.transform=hs;
